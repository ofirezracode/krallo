    ...
    <ul className="app-header flex between clean-list">
      ...
      <li>
        <ul className="app-header-links flex">
          ...
          <li>
            <button className="btn btn-icon" title="Dark mode">
              <BsCircleHalf />
            </button>
          </li>
          <li>
            <button className="btn btn-icon logout" onClick={onLogout} title="Logout">
              <BsFillPersonXFill />
            </button>
          </li>
          <li>
            <button className="user-img-header flex">
              <UserImg size="small" hover="circle" userImg={userImg} padding={true} />
            </button>
          </li>
        </ul>
      </li>
