  ...
  return (
    <ul className="app-header flex between clean-list">
      <li className="gray-logo flex">
        <Link className="logo-link" to="/workspaces" className='flex align-center'>
          <BsTrello />
          <div>
            Krallo
          </div>
