...
import { BsBell, BsCircleHalf, BsSearch, BsTrello } from "react-icons/bs"; // To use icons or svg?
    ...
    <ul className="app-header flex between clean-list">
      ...
      <li>
        <ul className="app-header-links flex">
          ...
          <li>
            <button className='user-img-header flex'><UserImg size='small' hover='hover' /></button>
          </li>
        </ul>
      </li >
    </ul >
