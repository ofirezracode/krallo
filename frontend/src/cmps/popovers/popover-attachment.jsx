      ...
      <section className="popover-attachment">
        ...
        <div className="url-input">
          ...
          <form onSubmit={onSubmitUrl}>
            <h5>Attach a link</h5>
            <input type="text" placeholder="Paste any link here..." value={url} onChange={(ev) => setUrl(ev.target.value)} autoFocus />
            {url.length > 0 && (
              <div>
        ...
        <div className="url-ai-input">
          <hr />
          <form onSubmit={generatorImg}>
            <h5>Use the AI photo generator</h5>
            <input className='gradient-border' type="text" placeholder="What's on your imagination?" value={userPrompt} onChange={(ev) => setUserPrompt(ev.target.value)} />
