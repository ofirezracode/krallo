    ...
    <section>
      <ul className="board-header clean-list flex align-center between">
        <li className='flex align-center'>
          ...
          {board.isStarred ? <button className='btn-star' title='Click to star or unstar this board. Starred boards show up at the top of your boards list.' onClick={(ev) => toggleIsStarred(ev, board)}><Link><BsStarFill className="star-fill" /></Link></button> :
            <button className='btn-star' title='Click to star or unstar this board. Starred boards show up at the top of your boards list.' onClick={(ev) => toggleIsStarred(ev, board)}><Link><BsStar className="star-empty" strokeWidth={'1px'} /></Link></button>}
          <button title='Change visibility'>
            <Link className='flex align-center between'>
