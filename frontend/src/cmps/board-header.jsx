    ...
    <section>
      <ul className="board-header clean-list flex align-center between">
        <li className='flex align-center'>
          <h1>{board.title}</h1>
          {board.isStarred ? <button className='btn-star' onClick={(ev) => toggleIsStarred(ev, board)}><Link><BsStarFill className="star-fill" /></Link></button> :
            <button className='btn-star' onClick={(ev) => toggleIsStarred(ev, board)}><Link><BsStar className="star-empty" strokeWidth={'1px'} /></Link></button>}
          <button>
