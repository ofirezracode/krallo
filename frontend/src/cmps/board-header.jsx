      ...
      <ul className="board-header clean-list flex align-center between">
        <li className="flex align-center">
          ...
          {board.isStarred ? (
            ...
            >
              <Link>
                <BsStar className="star-empty" strokeWidth={'1px'} />
              </Link>
            </button>
          )}
          <button
            onClick={(e) => onTogglePopover(e, 'dummy', 'Change visibility')}
            title="Change visibility"
            className="flex align-center between"
          >
