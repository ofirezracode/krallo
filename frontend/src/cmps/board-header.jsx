    ...
    <section>
      <ul className="board-header clean-list flex align-center between">
        <li className='flex align-center'>
          ...
          {board.isStarred ? <button className='btn-star' title='Click to star or unstar this board. Starred boards show up at the top of your boards list.' onClick={(ev) => toggleIsStarred(ev, board)}><BsStarFill className="star-fill" /></button> :
            <button className='btn-star' title='Click to star or unstar this board. Starred boards show up at the top of your boards list.' onClick={(ev) => toggleIsStarred(ev, board)}><BsStar className="star-empty" /></button>}
          <button title='Change visibility flex align-center between'>
