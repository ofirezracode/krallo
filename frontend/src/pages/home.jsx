    ...
    <section className="home-first-container">
      <section className="home-container flex">
        <div className="home-txt">
          ...
          <Link className="signup-btn" to="/workspaces">Try demo - it’s free!</Link>
        </div>
          ...
          <div className="productivity-text-container flex wrap">
            <div>
              ...
              <div className="productivity-text">
                <p>Simple, flexible, and powerful. All it takes are boards, lists, and cards to get a clear view of who’s
